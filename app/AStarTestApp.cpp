...
bool AStarTestApp::run()
{
	...
	auto path = Search::aStar(navGraph[0], navGraph[7], Search::straightLineHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;

	path = Search::aStar(navGraph[7], navGraph[0], Search::straightLineHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;

	path = Search::aStar(navGraph[10], navGraph[1], Search::straightLineHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;
	...
	// Test diagonals: straight line.
	cout << "Diagonals: Straight Line" << endl;
	navGraph = createNavGraph2();
	path = Search::aStar(navGraph[0], navGraph[5], Search::straightLineHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;
	...
	cout << "Diagonals: Straight Line" << endl;
	navGraph = createNavGraph2();
	path = Search::aStar(navGraph[5], navGraph[0], Search::straightLineHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;

	// Test diagonals: straight line.
	cout << "Diagonals: Manhattan" << endl;
	navGraph = createNavGraph2();
	path = Search::aStar(navGraph[5], navGraph[0], Search::manhattanHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;

	// Test diagonals: manhattan.
	cout << "Diagonals: Manhattan" << endl;
	navGraph = createNavGraph2();
	path = Search::aStar(navGraph[0], navGraph[5], Search::manhattanHeuristic, true);
	Search::printPath(path);
	cout << endl << endl;
